"""Alembic migration environment for the medication-service (async engine).
...
DEFAULT_URL = "postgresql+asyncpg://adhera:adhera_dev_password@localhost:5432/medication"
