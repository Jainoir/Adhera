"""Adhera Identity and Consent Service — FastAPI application entry point."""
...
from shared.readiness import ping_database, ping_redis, readiness_report

configure_logging(settings)

app = FastAPI(
    title="Adhera Identity and Consent Service",
    version="0.1.0",
