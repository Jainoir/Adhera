"""Alembic migration environment for the notification-service (async engine).
...
DEFAULT_URL = "postgresql+asyncpg://adhera:adhera_dev_password@localhost:5432/notification"
